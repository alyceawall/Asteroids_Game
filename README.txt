...
If you are part of the INSPECTORS sent by Earth 1.0 Command to perform a quality check on our Station, please proceed down this message, below our asteroid art, to find a message from the Commander specifically for you. But, if you have the time, we encourage you to read the instructions we give incoming pilots as well! (Our Human Resource department put a lot of effort into it).

If you are a new PILOT, please read the following important message from Commander Lerner to learn what to expect on your first mission as an Atari Conductor Expert (A.C.E)
...
----------------------------------------------------------------------------------------------------
____A MESSAGE TO OUR VALUED INSPECTORS
All of our systems abroad the Terran Intergalactic Sation work perfectly! Please feel free to ensure this by personally taking an ACE Ship to the Asteroid Area-- Commander Lerner has granted you express permission to any ship despite your lack of InterSpace Aircraft Licenses.

However, our system tests are currently acting up. They appear to run perfectly on some hardware, and yield some fails on different hardware. If your testing devices show strange fails, specifically on the warp and heavy coordinate based tests, the T.I.S staff implores you to take a peek at the testing code itself to assure yourself that the logic there is sound. The getHeight and width dimensions appear to be on a hardware-by-hardware basis on what value they want to give. We hope Earth 1.0's Command Station will understand, as these hardware conditions are out of our staff's hands.

Thank you, and we hope you enjoy your time abroad the Terran Intergalactic Station



------Meteoroid art Copyrighted by BeaWasBoredOnAPlane Incorporated. 
            Do not distribute or replicate wihtout a license------
